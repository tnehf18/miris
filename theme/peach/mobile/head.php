...
<header id="hd" style="background-color:#fff;">
	...
	<div id="m_hd" class="m_view">
        <a href="<?php echo G5_URL ?>" class="m_logo"><img src="<?php echo G5_IMG_URL ?>/imgs/mirisci.png" style="width:100%; max-width:200px;" alt="<?php echo $config['cf_title']; ?>"></a>
    ...
    <div class="m_side_menu">
        ...
        <div id="hd_wrapper">
            ...
            <div id="logo" class="pc_view">
                <a href="<?php echo G5_URL ?>"><img src="<?php echo G5_IMG_URL ?>/imgs/mirisci.png" style="width:100%; max-width:200px;" alt="<?php echo $config['cf_title']; ?>"></a>
            </div>
            ...
            <div id="gnb">
                ...
                ?>
                    <li class="gnb_1dli" style="top:20px;">
...
<div id="wrapper">
    ...
    <div id="container">
		<?php if (!defined("_INDEX_")) { ?><h2 id="container_title" style="background-image:url(<?php echo G5_IMG_URL; ?>/imgs/background-2462431_1920.jpg);"><span title="<?php echo get_text($g5['title']); ?>"><?php echo get_head_title($g5['title']); ?></span></h2><?php } ?>
